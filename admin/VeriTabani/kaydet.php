...
$denetmenYorum=$_POST["denetimYorum"];
$kullaniciNo =$_SESSION["kullanici_id"];
...
$ekle= "INSERT INTO insaatkayit (id,kullaniciNo,adSoyad,insaatAdi,mailAdres,malzemeler,sirketAdi,telefonNo,maliyet,baslangicTarih,bitisTarih,denetmenYorum)  
                        VALUES (NULL,'$kullaniciNo','$adSoyad','$insaatAdi','$email','$malzemeler','$sirketadi','$telefonNo','$maliyet','$baslangictarihi','$bitistarihi','$denetmenYorum')";
...
return header("Location: http://localhost/insaat/admin/insaatKayit.php");