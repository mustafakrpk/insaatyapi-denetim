        ...
        <div class="card w-25 h-50 ">
                <div class="card m-4 border-info mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text alert alert-warning"><small class="text-muted">İnşaat'ın <br> Başlangıç Tarihi  : <?php echo $row["baslangicTarih"]." Bitiş Tarihi : ".$row["bitisTarih"] ?></b></small></p>
                        <p class="card-text alert alert-warning"><small class="text-muted"><b>İNŞAAT MALİYETİ  : <?php echo $row["maliyet"] ?></b></small></p>
                    </div>
                </div>
        </div>
</div>
