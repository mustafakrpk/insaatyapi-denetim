...
<div class="container mt-5">
    <form action="VeriTabani/kaydet.php" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                <label for="last">Maliyet</label>
                <input type="text" class="form-control" placeholder="" id="maliyet" name="maliyet">
                </div>
            </div>
            ...
            <!--  col-md-6   -->
            <div class="col-md-6 mt">
                <label for="insaatBaslama">Denetmen Yorumu</label>
                <textarea class="form-control" id="denetimYorum" style="height: 100px" name="denetimYorum"></textarea>
            </div>
